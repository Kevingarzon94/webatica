...
<?php
$_SESSION["sessionId1"] = $_GET["sessionId"];
$_SESSION["id1"] = $_GET["id"];
$_SESSION["Nit1"] = $_GET["nit"]; 
...
<html>
    ...
    <input id="sessionId" type="text" value="<?php echo $_GET["sessionId"] ?>" hidden>
    <input id="nitEmp" type="text" value="<?php echo $_GET["nit"] ?>" hidden>
    <input id="id" type="text" value="<?php echo $_GET["id"] ?>" hidden>
    <div>
      ...
      <div class="h-75" style="background-color:gainsboro;">
        ...
        <div class="mx-auto h-100 w-75" style="background-color: white;">
            <div style="background-color:00d0b7; margin: 0px;">          
              <div id="qab_content" style="text-align:center; display: inline-block;"><span id="qab_message"><p style="text-align:left;margin-left:5%;margin-top:10px;width:400px;"> <span style="margin-right:10px;margin-left:0px; color:white; "> EDITAR PERFIL CLIENTE </span></p> </span> 
              ...
              <form>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <input id="razon_social" type="text" class="form-control" disabled>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col">
                    <span>N.I.T</span>
                    <input id="nit_prov" type="text" class="form-control" disabled>
                  </div>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <input id="contacto_emp" value="" type="text" class="form-control" >
                  </div>
                </div>                
                <br>
                <div class="row">
                  <div class="col" style="margin-left:570px; margin-bottom:100px;"> 
                    <button type="button" style="background-color:00d0b7" onclick="updateinfoGral()"><span style="color:white; ">Guardar</span></button>                                
                  </div>
                </div>
              </form>
            </div>
