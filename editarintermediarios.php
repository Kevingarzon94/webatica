...
<head>
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js" integrity="sha384-vFJXuSJphROIrBnz7yo7oB41mKfc8JzQZiCq4NCceLEaO4IHwicKwpJf9c9IpFgh"
        crossorigin="anonymous"></script>
      <script src="controller/intermediarioseditar.js"></script>
          ...
          <ul class="nav justify-content-center mx-auto" >
              ...
              <button onclick="myFunction()" class="dropbtn">Info. General</button>
                <div id="myDropdown" class="dropdown-content">
                  ...
                  <a href="editarintermediario.php">Editar Intermediario</a>
      ...
      <div class="h-75" style="background-color:gainsboro;">
        ...
        <div class="mx-auto h-100 w-75" style="background-color: white;">
            <div style="background-color:00d0b7; margin: 0px;">          
              <div id="qab_content" style="text-align:center; display: inline-block;"><span id="qab_message"><p style="text-align:left;margin-left:5%;margin-top:10px;width:400px;"> <span style="margin-right:10px;margin-left:0px; color:white; "> CREAR GENERADOR INTERMEDIARIO </span></p> </span> 
            ...
            <div class="mx-auto w-50" >
              <form>
                ...
                <div class="row">
                  ...
                  <select class="form-control" name="sucursal" id="sucursal" onchange="callInfo()">
                    <option>Elija Intermediario</option>
                  </select>
                  </div>  
                </div>
                <br>
                <div class="row">
                  <div class="col">
                    ...
                    <input id="id_inter" type="text" class="form-control" hidden>
                  </div>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row">
                  <div class="col" style="margin-left:100px"> 
                    <button type="button" style="background-color:00d0b7" onclick="EditarInter()"><span style="color:white; ">Guardar</span></button>                                
                  </div>
                </div>
              </form>
            </div>
