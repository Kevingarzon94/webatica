...
<head>
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js" integrity="sha384-vFJXuSJphROIrBnz7yo7oB41mKfc8JzQZiCq4NCceLEaO4IHwicKwpJf9c9IpFgh"
        crossorigin="anonymous"></script>
      <script src="controller/intermediarios.js"></script>
            ...
            <div class="mx-auto w-50" >
              <form>
                ...
                <div class="row">
                  <div class="col">
                    <span>Nombre</span>
                    <input id="nombre_inter" type="text" class="form-control">
                  </div>  
                </div>
                <br>
                <div class="row">
                  <div class="col">
                    <span>N.I.T</span>
                    <input id="nit_inter" type="text" class="form-control">
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col">
                    <span>Direccion</span>
                    <input id="dir_inter" type="text" class="form-control">
                  </div>
                </div>
                <br>
                <div class="row">
